...
void uib_view1_config_HD_portrait() {
	...
	if(vc->grid1) {
		...
		if (!vc->button3) {
			vc->button3 = elm_button_add(vc->grid1);
		}
		if (vc->button3) {
			evas_object_size_hint_align_set(vc->button3, -1.0, -1.0);			evas_object_size_hint_weight_set(vc->button3, 1.0, 1.0);			elm_object_text_set(vc->button3,_UIB_LOCALE("Schedule"));
			elm_object_style_set(vc->button3,"default");
			evas_object_show(vc->button3);
		}
		if (!vc->button4) {
			vc->button4 = elm_button_add(vc->grid1);
		}
		if (vc->button4) {
			evas_object_size_hint_align_set(vc->button4, -1.0, -1.0);			evas_object_size_hint_weight_set(vc->button4, 1.0, 1.0);			elm_object_text_set(vc->button4,_UIB_LOCALE("Sensors"));
			elm_object_style_set(vc->button4,"default");
			evas_object_show(vc->button4);
		}
		if (!vc->button5) {
			vc->button5 = elm_button_add(vc->grid1);
		}
		if (vc->button5) {
			evas_object_size_hint_align_set(vc->button5, -1.0, -1.0);			evas_object_size_hint_weight_set(vc->button5, 1.0, 1.0);			elm_object_text_set(vc->button5,_UIB_LOCALE("Display Temperature"));
			elm_object_style_set(vc->button5,"default");
			evas_object_show(vc->button5);
		}
		elm_grid_pack(vc->grid1, vc->button1, 100, 850, 800, 80);		elm_grid_pack(vc->grid1, vc->label1, 150, 50, 700, 80);		elm_grid_pack(vc->grid1, vc->button3, 99, 778, 800, 50);		elm_grid_pack(vc->grid1, vc->button4, 100, 717, 798, 50);		elm_grid_pack(vc->grid1, vc->button5, 100, 642, 800, 49);		evas_object_show(vc->grid1);
	}
}
